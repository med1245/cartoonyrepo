...
res1 = get_decrypted("https://carateen.tv/api/episode?episodeId=5068")
print(res1)

res2 = get_decrypted("https://carateen.tv/api/sp/episodes?id=506")
print(res2)

res3 = get_decrypted("https://carateen.tv/api/episodes?id=506")
print(res3)
